...
class Data():
    ...
    def handle_price_data(self):
        ...
        self.all_price_dict = {'open': self.all_open, 
                              'high': self.all_high, 
                              'low': self.all_low, 
    ...
    def format_price_data(self,item):
        ...
        pivot_data = selected_data.pivot_table(index='date', columns='company_symbol', values=item)
        return pivot_data
    ...
    def format_report_data(self,factor):
        ...
        for unique_id in unique_ids:
            temp_df =  self.raw_report_data[ self.raw_report_data['factor_name'] == unique_id].pivot(index='date', columns='company_symbol', values='factor_value')
